...
//레이지 아츠
final List rageArts = ["Wang's Celestial Epic", "레이지 상태에서 ${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"back" : true}, {"sit" : true}, {"hypnotist" : true}, {"phoenix" : true}
];
        ...
        child: Column(
            ...
            children: [
              ...
              if(heatSystemMenu == true) // 히트 시스템 설명
                SizedBox(child: heatSystemContexts(["파워가 상승한 Hypnotist", "Bai Yang Yan Di Po, Bai Lian Yan Di Po 사용 가능"])), //변경해야될것
