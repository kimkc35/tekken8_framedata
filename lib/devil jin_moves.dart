...
//레이지 아츠
final List rageArts = ["Devil Dimension: Tainted Chains", "레이지 상태에서 ${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"sit" : true}, {"wind god step" : true}, {"fly" : true}, {"mourning crow" : true}
];
        ...
        child: Column(
            ...
            children: [
              ...
              if(heatSystemMenu == true) // 히트 시스템 설명
                SizedBox(child: heatSystemContexts(["Ray 사용 가능", "최속 입력이 아니더라도 Electric Wind God Fist 사용 가능"])), //변경해야될것
