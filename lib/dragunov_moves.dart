...
//레이지 아츠
final List rageArts = ["White Angel of Death", "레이지 상태에서 ${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List<Map<String, String>> extraInitials = [ //변경해야될것,
  ...
  {"name" : "sneak", "sneak" : "${main.sticks["c3"]}~입력 시 Sneak로/()는 이행 시 프레임"}
];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"sit" : true}, {"sneak" : true}
];
        ...
        child: Column(
            ...
            children: [
              ...
              if(heatSystemMenu == true) // 히트 시스템 설명
                SizedBox(child: heatSystemContexts(["Feint & Catch, Ambush Tackle이 잡기 풀기 불가능", "일부 연계에서 Ambush Tackle 사용 가능"])), //변경해야될것
