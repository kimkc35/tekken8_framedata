...
//레이지 아츠
final List rageArts = ["Dark Dragon Commandment", "레이지 상태에서 ${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"sit" : true}, {"hermit" : true}, {"cane" : true}
];
        ...
        child: Column(
            ...
            children: [
              ...
              if(heatSystemMenu == true) // 히트 시스템 설명
                SizedBox(child: heatSystemContexts(["Chain Punch를 비롯한 고속 연속 공격의 가드 대미지 증가", "리로이 고유의 흘리기, 반격기를 성공하면 히트 상태의 남은 시간 회복 가능"])), //변경해야될것
