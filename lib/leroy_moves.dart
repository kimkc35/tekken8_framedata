                    ...
                    columns: [
                      DataColumn(label: SizedBox(
                        ...
                        child: MenuAnchor( // 커맨드 체크박스
                          ...
                          builder: (context, MenuController controller, Widget? child)=> TextButton(onPressed: () {
        ...
        child: DataTable(
          ...
          rows: [
            for(int i = 0; i < widget.throws.length; i++)...[
              DataRow(cells: createThrow(context, character, widget.throws[i][0], widget.throws[i][1], widget.throws[i][2], widget.throws[i][3], widget.throws[i][4], widget.throws[i][5], widget.throws[i][6], widget.throws[i][7]), color: MaterialStateColor.resolveWith((states) {
                return i % 2 == 0? const Color(0xffd5d5d5) : const Color(0xffffffff);
              }))
            ]
          ],
        ),
