...
class RAVEN extends StatefulWidget {
  ...
  const RAVEN({super.key, required this.moves, required this.throws});

  @override
  State<RAVEN> createState() => _RAVENState();
}
          ...
          Column(
            ...
            children: [
              ...
              if(heatSystemMenu == true) // 히트 시스템 설명
                SizedBox(child: heatSystemContexts(["분신을 사용한 공격이 가드당했을 때 자동으로 추가 공격 발동", "분신을 사용한 공격이 히트했을 때 히트 상태의 남은 시간 회복", "Typhon Fang Phantom 사용 가능"])), //변경해야될것
