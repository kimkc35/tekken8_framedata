...
//레이지 아츠
final List rageArts = ["Wild Hunt X-ecutor", "레이지 상태에서 ${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"sit" : true}, {"shadow sprint" : true}, {"soulzone" : true}
];
