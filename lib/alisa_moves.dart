...
//변경해야될것
class ALISA extends StatefulWidget {

  final moves, throws;

  const ALISA({super.key, required this.moves, required this.throws});

  @override
  State<ALISA> createState() => _ALISAState();
}

class _ALISAState extends State<ALISA> {
