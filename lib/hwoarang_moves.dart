...
//레이지 아츠
final List rageArts = ["Sky Burial", "${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"standing" : true}, {"shark step" : true}, {"right stance" : true}, {"left flamingo" : true}, {"right flamingo" : true}
];

Map<String, String> typesKo = {
  "heat" : "히트", "general" : "일반", "standing" : "기상", "shark step" : "샤크 스텝", "right stance" : "오른자세", "left flamingo" : "왼플라밍고", "right flamingo" : "오른플라밍고"
};
