...
//레이지 아츠
final List rageArts = ["스카이 베리얼", "레이지 상태에서 ${sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "오른 자세, 왼 플라밍고, 오른 플라밍고 도중에도 사용 가능\n레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : false}, {"general" : false}, {"sit" : false}, {"shark step" : false}, {"right stance" : false}, {"left flamingo" : false}, {"right flamingo" : false}
];
