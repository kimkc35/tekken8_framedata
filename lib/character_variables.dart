...
Character dragunov = Character(
  name: "dragunov",
  heatSystem: ["페인트 & 캐치, 앰부시 태클이 잡기 풀기 불가능", "일부 연계에서 앰부시 태클 사용 가능", "저스트 입력을 사용하지 않더라도 이너셔 킥을 가드하게 만들어서 잡기 기술로 이행 가능"],
  rageArts: MoveInfo(name: "화이트 엔젤 오브 데스", command: "레이지 상태에서 ${sticks["c3"]}AP", startFrame: "20", guardFrame: "-15", hitFrame: "D", counterFrame: "D", range: "중단", damage: "55", extra: "레이지 아츠\n히트 시 상대방의 회복 가능 게이지 소멸", startAt: 62, endAt: 77),
  types: {"heat" : false, "general" : false, "sit" : false, "pigeon roll": false, "sneak" : false},
  typesKo: {"heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "pigeon roll": "피전 롤", "sneak" : "스네이크"},
  videoId: "gC-tC-qwNZs"
);
...
Character jun = Character(
  name: "jun",
  heatSystem: ["카자마의 힘(체력 소비 기술) 체력 소비량이 완화됨", "파워가 상승한 감념상벽 사용 가능", "황천진어주 사용 가능", "히트 버스트 사용 시 카자마의 신기 5 증가", "히트 발동기 사용 시 카자마의 신기 10 증가"],
  rageArts: MoveInfo(name: "아마츠 이자나미", command: "레이지 상태에서 ${sticks["c3"]}AP", startFrame: "20", guardFrame: "-15", hitFrame: "D", counterFrame: "D", range: "중단", damage: "55", extra: "레이지 아츠\n히트 시 상대방의 회복 가능 게이지 소멸", startAt: 43, endAt: 58),
  types: {"heat" : false, "general" : false, "sit" : false, "izumo" : false, "genjitsu" : false, "miare" : false, "kazama essence": false},
  typesKo: {
    "heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "izumo" : "이즈모", "genjitsu" : "환일", "miare" : "미아레", "kazama essence": "카자마의 신기"
  },
  videoId: "HWRp14BKC34"
);
...
Character leo = Character(
  ...
  rageArts: MoveInfo(name: "건곤회천황", command: "레이지 상태에서 ${sticks["c3"]}AP", startFrame: "20", guardFrame: "-15", hitFrame: "D", counterFrame: "D", range: "중단", damage: "55", extra: "레이지 아츠\n히트 시 상대방의 회복 가능 게이지 소멸", startAt: 45, endAt: 59),
  types: {"heat" : false, "general" : false, "sit" : false, "lightning glare": false, "jin bu" : false, "jin ji du li" : false, "fo bu" : false},
  typesKo: {
    "heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "lightning glare": "섬전", "jin bu" : "진보", "jin ji du li" : "금계독립", "fo bu" : "부보"
  },
  videoId: "NaYFkO6OwjE"
);
...
Character lili = Character(
  name: "lili",
  heatSystem: ["파워가 상승한 파이스티 래빗, 피어싱 톤 사용 가능", "화이트 스완 메조 피아노 사용 가능"],
  rageArts: MoveInfo(name: "라 비 앙 로즈 포르티시시모", command: "레이지 상태에서 ${sticks["c3"]}AP", startFrame: "20", guardFrame: "-15", hitFrame: "D", counterFrame: "D", range: "중단", damage: "55", extra: "레이지 아츠\n히트 시 상대방의 회복 가능 게이지 소멸", startAt: 41, endAt: 54),
  types: {"heat" : false, "general" : false, "back":false, "sit" : false, "dew glide" : false, "feisty rabbit" : false},
  typesKo: {
    "heat" : "히트", "general" : "일반", "back": "뒤돈 자세", "sit" : "앉은 자세", "dew glide" : "듀 글라이드", "feisty rabbit" : "파이스티 래빗"
  },
  videoId: "sGIFlJzWJ94"
);
...
Character paul = Character(
  name: "paul",
  heatSystem: ["파워가 상승한 붕권 사용 가능", "파워가 상승한 홀드기 사용 가능", "만성벽력장 사용 가능"],
  rageArts: MoveInfo(name: "빅뱅폭권", command: "레이지 상태에서 ${sticks["c3"]}AP", startFrame: "20", guardFrame: "-15", hitFrame: "D", counterFrame: "D", range: "중단", damage: "55", extra: "레이지 아츠\n히트 시 상대방의 회복 가능 게이지 소멸", startAt: 29, endAt: 42),
  types: {"heat" : false, "general" : false, "sit" : false, "cormorant step" : false, "deep dive": false, "sway" : false},
  typesKo: {
    "heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "cormorant step" : "잠복 스텝", "deep dive": "이중 잠복", "sway" : "부초(스웨이)"
  },
  videoId: "kxEUjyHiuDA"
);
...
Character lidia = Character(
  name: "lidia",
  heatSystem: ["천상천하 자세 사용 가능", "파워가 상승한 AP, →→~RP, →→→~LP, 전호후랑 자세 중 LP 사용 가능"],
  ...
  typesKo: {"heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "horse stance" : "말 자세", "cat stance" : "묘족 자세", "wolf stance" : "전호후랑 자세", "heaven and earth" : "천상천하 자세"},
  videoId: "ZYSdvZ6qaEk"
);
