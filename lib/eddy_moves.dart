...
//레이지 아츠
final List rageArts = ["인셴치 지 아셰", "레이지 상태에서 ${sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List<String> heatSystem = ["게헤이루 에시플로지부 사용 가능", "하부 지 아하이아 리베라두 사용 가능"];

const character = "eddy"; //변경해야될것

List types = [ //변경해야될것
  {"heat" : false}, {"general" : false}, {"sit" : false}, {"bananeira" : false}, {"negativa" : false}, {"mandinga" : false}
];

Map<String, String> typesKo = {
  "heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "bananeira" : "바나네이라", "negativa" : "네가치바", "mandinga" : "만징가"
};
