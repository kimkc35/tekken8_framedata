...
//레이지 아츠
final List rageArts = ["Total Vandalization", "레이지 상태에서 ${main.sticks["c3"]}AP", "20", "-15", "D", "D", "중단", "55", "레이지 아츠\n히트 시 상대의 회복 가능 게이지를 없앰"];
...
List types = [ //변경해야될것
  {"heat" : true}, {"general" : true}, {"sit" : true}, {"snake eyes" : true}, {"slither step" : true}, {"sway" : true}
];

Map<String, String> typesKo = {
  "heat" : "히트", "general" : "일반", "sit" : "앉은 자세", "snake eyes" : "스네이크 아이즈", "slither step" : "슬리더 스텝", "sway" : "스웨이"
};
